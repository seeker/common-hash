 ...
 */
package com.github.seeker.commonhash.perceptual.phash;
...
public class ImagePHashTest {
	...
	//TODO use package prefix for test image resource
	
	@BeforeClass
	public static void setUpClass() throws Exception {
		testImageJPG = findFilePath("image/testImage.jpg");
		testImagePNG = findFilePath("image/testImage.png");
		testImageGIF = findFilePath("image/testImage.gif");
		testImageBMP = findFilePath("image/testImage.bmp");

		testImageSmallJPG = findFilePath("image/testImage_small.jpg");

		testImagePNGtr = findFilePath("image/testImage-with-transparency.png");
		testImageGIFtr = findFilePath("image/testImage-with-transparency.gif");
	}
